...
export default function Home() {
    ...
    return (
        <main className="container mx-auto py-[150px]  px-[200px] h-full">
            <div className="grid grid-cols-2">
                <div className="col-span-1 text-white h-full flex flex-col gap-y-5">
                    ...
                    <p className="w-3/4 text-sm text-[#8a99ad] leading-7">{data_intro.intro}</p>
                ...
                <div className="col-span-1">
                    <p className="text-[#8a99ad] leading-9">
                        ...
                        {convert_link('Javascript', 'https://vi.wikipedia.org/wiki/JavaScript')}. Fast forward to today
                        and I have been able to build larger website interfaces for an advertising agency, a startup.
                    </p>
                    <p className="text-[#8a99ad] leading-9">
                    ...
                    <p className="text-[#8a99ad] leading-9">
                        ...
                        {convert_link('ReactJS', 'https://react.dev/')}, library, a powerful Javascript library
                        developed by Facebook. It helps me a lot in building user interfaces. After that, I continued to
                        learn
                        {convert_link('NodeJS', 'https://nodejs.org/en')},
                        {convert_link('MongoDB', 'https://www.mongodb.com/fr-fr')}, to support the back-end website
                        building towards the goal of
