...
function Contact() {
    return (
        <>
            ...
            />
            <div className="grid grid-cols-2 justify-center gap-8 text-[var(--color-primary)] font-extrabold mt-10">
                <div className="col-span-1 flex flex-col gap-4 rounded-lg justify-center items-center w-full h-48 bg-[var(--color-box)]">
